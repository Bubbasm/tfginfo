...
start_index = -67+long_periodo*2;       % Starting index of the time period
end_index = start_index + long_periodo; % Ending index of the time period


% Select the data within the specified time period
x_period = x(start_index:end_index);
y_period = y(start_index-long_periodo:start_index)-y(start_index:end_index);
z_period = z(start_index-long_periodo:start_index)-z(start_index:end_index);
