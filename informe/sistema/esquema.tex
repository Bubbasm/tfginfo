\begin{figure}[Proceso completo de detección de anomalías en el tráfico de red]{FIG:PROCESOCOMPLETO}{Proceso completo de detección de anomalías en el tráfico de red}
    \image{}{}{procesocompleto.pdf}
\end{figure}
